...
<div class="items-box">
  <div class="item1">
    <img src="${item.item_image1}" alt="No image"
    onclick="clickme(this)"/>
  </div>
  <div class="item1">
    <img src="${item.item_image2}" alt="No image"
    onclick="clickme(this)"/>
  </div>
  <div class="item1">
    <img src="${item.item_image3}" alt="No image"
    onclick="clickme(this)"/>
  </div>
  <div class="item1">
    <img src="${item.item_image4}" alt="No image"
    onclick="clickme(this)"/>
  </div>
  <div class="item1">
    <img src="${item.item_image5}" alt="No image"
    onclick="clickme(this)"/>
  </div>
</div>
<div class="main-item">
  <img src="${item.item_image1}" alt="No image" id="main-img"/>
</div>
</div>
...
<p class="product-item-name">Author</p>
</div>
<div class="product-box">
<p class="product">${item.productDetels.Author}</p>
</div>
</div>

<div class="box1">
<div class="product-item-name-box">
<p class="product-item-name">Highlights</p>
</div>
<div class="product-box">
<p class="product">${item.productDetels.Highlights}</p>
</div>
</div>

<div class="box1">
<div class="product-item-name-box">
<p class="product-item-name">Seller</p>
</div>
<div class="product-box">
<p class="product">${item.productDetels.Seller}</p>
</div>
</div>

<div class="box1">
<div class="product-item-name-box">
<p class="product-item-name">Width</p>
</div>
<div class="product-box">
<p class="product">${item.productDetels.Width}</p>
</div>
</div>

<div class="box1">
<div class="product-item-name-box">
<p class="product-item-name">Height</p>
</div>
<div class="product-box">
<p class="product">${item.productDetels.Height}</p>
</div>
</div>
...
<div class="box1">
<div class="product-item-name-box">
<p class="product-item-name">Depth</p>
</div>
<div class="product-box">
<p class="product">${item.productDetels.Depth}</p>
</div>
</div>

<div class="box1">
<div class="product-item-name-box">
<p class="product-item-name">Description</p>
</div>
<div class="product-box">
<p class="product">${item.productDetels.Description}</p>
</div>
</div>
</div>
</div>
...
function generateSimilarProductHTML(product) {
  return `
    ...
    <div class="similar-product-image-main-container"
